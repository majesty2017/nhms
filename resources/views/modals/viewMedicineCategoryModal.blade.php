<!-- Modal -->
<div class="modal fade" id="viewMedicineCategoryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" name="" id="med_category_id">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="" id="med_category_description" readonly>
                </div>
